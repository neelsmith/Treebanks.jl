...
md"""# Resolving AGLDT lemma values"""

# ╔═╡ 575b1eaf-cc54-480c-a7f4-fee79fb08097
md"""*Candidate lemma*: $(@bind s confirm(TextField(placeholder = "μῆνις")))"""


# ╔═╡ 0b3b1395-6fdf-4f02-ba17-03688c816733
md"""
*Show* `n` *closest near matches* $(@bind n Slider(2:20, default = 5, show_value = true))
"""
...
# ╔═╡ 5cf4808e-cc6d-495b-8a6f-de5d3cf5b874
pairs |> length

# ╔═╡ 10f7a947-f691-4d61-85de-d3796ac3f95e
lsjxlines |> length

# ╔═╡ 3136ba12-a9db-458d-be38-32785193dc55
pairs[248]
